...
template<class ItemType> void QSort(ItemType values[], int first, int last);
template<class ItemType> void Split(ItemType values[], int first, int last, int& splitPoint);
...
void Split(ItemType values[], int first, int last, int& splitPoint)
{
    ...
    splitPoint = last;
	std::cout << "Big count executed with " << bigCount << std::endl;
